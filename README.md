...
## **Mobile App Template** - *Mobile Responsive* `(static page)`
...
This project is a mobile app download  that contains a google play store icon which insist user to download an app. In this project, I learned to create a nav-bar with HTML & CSS and stick background at fixed position. I also learned to use creativity with code and some basics of CSS and also media queries property of CSS, which makes the task very easier.
...
![Project Snapshot](./images/mobile-app-template-thumbnail.png)
...
[<img alt="Go Live" width="170px" src="https://user-images.githubusercontent.com/110058268/192381169-8441c110-50f4-43a0-9ab1-b4cd6c509f95.png" />](https://cypherakshay-mobile-app.netlify.app/ "Go Live")
